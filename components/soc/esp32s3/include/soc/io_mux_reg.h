...
#define PIN_SLP_INPUT_ENABLED(PIN_NAME)     GET_PERI_REG_MASK(PIN_NAME,SLP_IE)
#define PIN_SLP_OUTPUT_ENABLE(PIN_NAME)     SET_PERI_REG_MASK(PIN_NAME,SLP_OE)
#define PIN_SLP_OUTPUT_DISABLE(PIN_NAME)    CLEAR_PERI_REG_MASK(PIN_NAME,SLP_OE)
#define PIN_SLP_OUTPUT_ENABLED(PIN_NAME)    GET_PERI_REG_MASK(PIN_NAME,SLP_OE)
...
#define PIN_SLP_PULLUP_ENABLED(PIN_NAME)    GET_PERI_REG_MASK(PIN_NAME,SLP_PU)
...
#define PIN_SLP_PULLDOWN_ENABLED(PIN_NAME)  GET_PERI_REG_MASK(PIN_NAME,SLP_PD)
#define PIN_SLP_SEL_ENABLE(PIN_NAME)        SET_PERI_REG_MASK(PIN_NAME,SLP_SEL)
#define PIN_SLP_SEL_DISABLE(PIN_NAME)       CLEAR_PERI_REG_MASK(PIN_NAME,SLP_SEL)
#define PIN_SLP_SEL_ENABLED(PIN_NAME)       GET_PERI_REG_MASK(PIN_NAME,SLP_SEL)

#define PIN_INPUT_ENABLE(PIN_NAME)          SET_PERI_REG_MASK(PIN_NAME,FUN_IE)
#define PIN_INPUT_DISABLE(PIN_NAME)         CLEAR_PERI_REG_MASK(PIN_NAME,FUN_IE)
#define PIN_INPUT_ENABLED(PIN_NAME)         GET_PERI_REG_MASK(PIN_NAME,FUN_IE)
#define PIN_SET_DRV(PIN_NAME, drv)          REG_SET_FIELD(PIN_NAME, FUN_DRV, (drv));
#define PIN_PULLUP_DIS(PIN_NAME)            REG_CLR_BIT(PIN_NAME, FUN_PU)
#define PIN_PULLUP_EN(PIN_NAME)             REG_SET_BIT(PIN_NAME, FUN_PU)
#define PIN_PULLUP_ENABLED(PIN_NAME)        REG_GET_BIT(PIN_NAME, FUN_PU)
#define PIN_PULLDWN_DIS(PIN_NAME)           REG_CLR_BIT(PIN_NAME, FUN_PD)
#define PIN_PULLDWN_EN(PIN_NAME)            REG_SET_BIT(PIN_NAME, FUN_PD)
#define PIN_PULLDWN_ENABLED(PIN_NAME)       REG_GET_BIT(PIN_NAME, FUN_PD)
#define PIN_FUNC_SELECT(PIN_NAME, FUNC)     REG_SET_FIELD(PIN_NAME, MCU_SEL, FUNC)
#define PIN_FUNC_GET(PIN_NAME, FUNC)        REG_GET_FIELD(PIN_NAME, MCU_SEL, FUNC)
...
#define PIN_FILTER_ENABLED(PIN_NAME)        REG_GET_BIT(PIN_NAME, FILTER_EN)
